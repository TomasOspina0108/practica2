...
class Main {
    ...
    static void cargarArchivo() throws IOException{
        ...
        try(Stream<String> lines = Files.lines(Path.of(filename))){
            estudiantes=lines.skip(1).map(line->{
                ...
                return new Student(var2[1], var2[2], (var2[4]), var2[9], Integer.parseInt(var2[10]));
    ...
    static void mostrarEstudiantesPorCarrera(){
        ...
        Map<String, List<Student>> agrupadoPorCarrera =
                estudiantes.stream()
                        .collect(Collectors.groupingBy(Student::getCarrera));
    ...
    static void mostrarEstudiantesMujeres() {
        ...
        estudiantes.stream()
                .filter(estudiante -> "female".equals(estudiante.getGenero()))
    ...
    static void mostrarEstudianteshombres() {
        ...
        estudiantes.stream()
                .filter(estudiante -> "male".equals(estudiante.getGenero()))
                .forEach(estudiante -> System.out.printf(" %s%n", estudiante));
    }
    ...
    static void EstMejorNotaCarrera(){
        ...
        System.out.printf("%nEstudiante Con Mejor Nota Por Carrera: %n");
        Map<String, List<Student>> agrupadoPorCarrera =
                estudiantes.stream()
                        .collect(Collectors.groupingBy(Student::getCarrera));
        agrupadoPorCarrera.forEach(
